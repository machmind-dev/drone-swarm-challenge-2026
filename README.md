...
| Version | Event | MCU | Specs | ToF | Vision | ArUco |
|---------|-------|-----|-------|-----|--------|-------|
| [v1.0](drone-firmware/v1.0/) | Qualifying | S3 | 240 MHz / 8 MB | 4 | Offboard | 80×60 / up to 4 m |
| [v2.0](drone-firmware/v2.0/) | Finals | S3 & P4 | 240/360 MHz / 8/32 MB | 6 | Onboard | 320×240 / up to 12 m |
